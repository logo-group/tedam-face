...
@SpringComponent
@ViewScope
public class TedamDynamicGridDoubleClick extends TedamDynamicGrid<List<GridCell>> implements TedamLocalizerWrapper {
     ...
     */
    public TedamDynamicGridDoubleClick() {
        super(SelectionMode.SINGLE);
    }

...
public class GridColumns {
	...
	public static enum GridColumn {
		...
		JOB_ENVIRONMENT_NAME("jobEnvironmentName", "column.job.environmentName", DataType.TEXT, null, true, false, true), //
		 ...
		 * JOB_GROUPCOLUMNS
		 */
		JOB_GROUP_NAME("name", "column.jobgroup.name", DataType.TEXT, null, false, false, true), //
		JOB_GROUP_DESCRIPTION("description", "column.jobgroup.description", DataType.TEXT, null, false, false, true), //
		/**
		 * JOB_DETAIL_COLUMNS
		 */
		 ...
		 */
		NOTIFICATION_GROUP_NAME("groupName", "column.notificationGroup.groupName", DataType.TEXT, null, true, false, true),

		RECIPIENT_ADDRESS("address", "column.Recipient.address", DataType.TEXT, null, true, false, true);

		public static final List<GridColumn> TEST_CASE_TEST_RUN_COLUMNS = Arrays.asList(ID, TEST_RUN_VERSION, TEST_RUN_CLIENT, TEST_RUN_JOB_NAME, TEST_RUN_TEST_SET_NAME,
				TEST_RUN_TEST_CASE, TEST_RUN_TYPE, TEST_RUN_EXECUTION_STATUS, TEST_RUN_ACTUAL_DURATION, TEST_RUN_START_DATE, TEST_RUN_END_DATE, CREATED_USER, CREATED_DATE,
				UPDATED_USER, UPDATED_DATE);

		public static final List<GridColumn> TEST_STEP_TEST_CASE_TEST_RUN_COLUMNS = Arrays.asList(ID, TEST_RUN_VERSION, TEST_RUN_CLIENT, TEST_RUN_JOB_NAME, TEST_RUN_TEST_CASE,
				TEST_RUN_TYPE, TEST_RUN_EXECUTION_STATUS, TEST_RUN_ACTUAL_DURATION, TEST_RUN_START_DATE, TEST_RUN_END_DATE, CREATED_USER, CREATED_DATE, UPDATED_USER, UPDATED_DATE);
		...
		public static final List<GridColumn> JOB_COLUMNS = Arrays.asList(ID, JOB_NAME, JOB_TYPE, JOB_ENVIRONMENT_NAME, JOB_EXECUTION_DURATION, JOB_LAST_EXECUTOR,
				JOB_LAST_EXECUTED_START_DATE, JOB_LAST_EXECUTED_END_DATE, JOB_IS_CI, JOB_STATUS, CREATED_USER_NOT_HIDDEN, CREATED_DATE, UPDATED_USER, UPDATED_DATE);

		public static final List<GridColumn> JOB_GROUP_COLUMNS = Arrays.asList(ID, JOB_GROUP_NAME, JOB_GROUP_DESCRIPTION, CREATED_USER_NOT_HIDDEN, CREATED_DATE, UPDATED_USER,
				UPDATED_DATE);

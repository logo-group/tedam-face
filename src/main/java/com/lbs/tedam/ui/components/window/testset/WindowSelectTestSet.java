...
@SpringComponent
@ViewScope
public class WindowSelectTestSet extends TedamWindow {
    ...
    @Autowired
    public WindowSelectTestSet(WindowTestSetDataProvider gridDataProviderTestSet, ViewEventBus viewEventBus, PropertyService propertyService) {
    ...
    protected Component buildContent() {
        ...
        gridTestSets = new TedamFilterGrid<>(gridConfigFiles, gridDataProviderTestSet, SelectionMode.SINGLE);
		gridTestSets.setId("TestSetSelectWindow");
        return gridTestSets;
    }

    @Override
    public void publishCloseSuccessEvent() {
        getEventBus().publish(this, new TestSetSelectEvent(gridTestSets.getSelectedItems().iterator().next()));
    }

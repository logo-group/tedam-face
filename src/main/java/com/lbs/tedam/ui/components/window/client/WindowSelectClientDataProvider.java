...
@SpringComponent
@PrototypeScope
public class WindowSelectClientDataProvider extends AbstractDataProvider<Client> {

    private static final long serialVersionUID = 1L;

    @Autowired
    public WindowSelectClientDataProvider(ClientService clientService) throws LocalizedException {

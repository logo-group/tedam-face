...
@SpringComponent
@ViewScope
public class GridRowSelectWindowPresenter extends AbstractWindowPresenter<WindowTestStepTypeGridRowSelect> {
    ...
    @Autowired
    public GridRowSelectWindowPresenter(TedamGridTagComboBoxDataProvider tedamGridComboBoxDataProvider,
    ...
    public void fillComponentsWithValues() throws LocalizedException {
        ...
        GridRowSelectGenerator generator = (GridRowSelectGenerator) testStep.getGenerator();
    ...
    private void buildTedamGridComboBoxDataProvider() throws LocalizedException {
        ...
        getWindow().getTedamGridComboBox().setDataProvider(tedamGridComboBoxDataProvider.getListDataProvider());
    }

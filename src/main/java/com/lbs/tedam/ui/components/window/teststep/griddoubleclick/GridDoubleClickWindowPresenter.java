...
@SpringComponent
@ViewScope
public class GridDoubleClickWindowPresenter extends AbstractWindowPresenter<WindowTestStepTypeGridDoubleClick> {
    ...
    @Autowired
    public GridDoubleClickWindowPresenter(TedamGridTagComboBoxDataProvider tedamGridComboBoxDataProvider,
    ...
    public void fillComponentsWithValues() throws LocalizedException {
        ...
        GridDoubleClickGenerator generator = (GridDoubleClickGenerator) testStep.getGenerator();

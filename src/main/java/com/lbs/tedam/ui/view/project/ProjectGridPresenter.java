...
@SpringComponent
@ViewScope
public class ProjectGridPresenter extends AbstractGridPresenter<Project, ProjectService, ProjectGridPresenter, ProjectGridView> {
    ...
    @Autowired
    public ProjectGridPresenter(ProjectDataProvider projectDataProvider, NavigationManager navigationManager, ProjectService service, BeanFactory beanFactory,
                                ViewEventBus viewEventBus, PropertyService propertyService, TedamUserService userService) {
        super(navigationManager, service, projectDataProvider, beanFactory, viewEventBus, propertyService, userService);
    }

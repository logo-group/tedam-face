...
@SpringComponent
@ViewScope
public class VerifyEditPresenter extends AbstractFillTestStepEditPresenter<VerifyEditPresenter, VerifyEditView> {
    ...
    @Autowired
    public VerifyEditPresenter(ViewEventBus viewEventBus, NavigationManager navigationManager, SnapshotDefinitionService snapshotDefinitionService, TedamUserService userService,
    ...
    public void enterView(Map<UIParameter, Object> parameters) throws LocalizedException {
        ...
        getView().buildChkIgnoreRowIndex();
        // TODO they look like a view business, we carry
    ...
    public String isChkIgnoreRowIndex() {
        boolean isChecked = getView().getChkIgnoreRowIndex().getValue();

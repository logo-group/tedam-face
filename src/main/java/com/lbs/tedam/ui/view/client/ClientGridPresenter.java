...
@SpringComponent
@ViewScope
public class ClientGridPresenter extends AbstractGridPresenter<Client, ClientService, ClientGridPresenter, ClientGridView> {
    ...
    @Autowired
    public ClientGridPresenter(ClientDataProvider clientDataProvider, NavigationManager navigationManager, ClientService service, BeanFactory beanFactory,
                               ViewEventBus viewEventBus, PropertyService propertyService, TedamUserService userService) {
        super(navigationManager, service, clientDataProvider, beanFactory, viewEventBus, propertyService, userService);
    }

...
@SpringComponent
@PrototypeScope
public class EnvironmentDataProvider extends AbstractDataProvider<Environment> {

    private static final long serialVersionUID = 1L;

    @Autowired
    public EnvironmentDataProvider(EnvironmentService environmentService, TedamUserService userService) throws LocalizedException {

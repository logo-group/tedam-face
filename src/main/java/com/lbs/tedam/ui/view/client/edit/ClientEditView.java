...
@SpringView
public class ClientEditView extends AbstractEditView<Client, ClientService, ClientEditPresenter, ClientEditView> {
    ...
    @Autowired
    public ClientEditView(ClientEditPresenter presenter) {
        super(presenter);
    }

    @Override
    public String getHeader() {
        return getLocaleValue("view.clientedit.header");
    }

    @PostConstruct
    private void initView() {
        name = new TedamTextField("view.clientedit.textfield.name", "full", true, true);

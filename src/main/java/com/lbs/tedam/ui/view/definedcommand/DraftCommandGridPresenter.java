...
@SpringComponent
@ViewScope
public class DraftCommandGridPresenter extends AbstractGridPresenter<DraftCommand, DraftCommandService, DraftCommandGridPresenter, DraftCommandGridView> {
    ...
    @Autowired
    public DraftCommandGridPresenter(DraftCommandDataProvider draftCommandDataProvider, NavigationManager navigationManager, DraftCommandService service, BeanFactory beanFactory,
                                     ViewEventBus viewEventBus, PropertyService propertyService, TedamUserService userService) {
        super(navigationManager, service, draftCommandDataProvider, beanFactory, viewEventBus, propertyService, userService);
    }

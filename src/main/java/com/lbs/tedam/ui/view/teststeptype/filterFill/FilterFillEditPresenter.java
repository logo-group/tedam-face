...
@SpringComponent
@ViewScope
public class FilterFillEditPresenter extends AbstractFillTestStepEditPresenter<FilterFillEditPresenter, FilterFillEditView> {
    ...
    @Autowired
    public FilterFillEditPresenter(ViewEventBus viewEventBus, NavigationManager navigationManager, SnapshotDefinitionService snapshotDefinitionService,
                                   TedamUserService userService, BeanFactory beanFactory, SnapshotValueDataProvider snapshotValueDataProvider, FormDefinitionService formDefinitionService,
    ...
    public void enterView(Map<UIParameter, Object> parameters) throws LocalizedException {
        ...
        // TODO they look like view a business, we carry

...
@SpringComponent
@ViewScope
public class EnvironmentGridPresenter extends AbstractGridPresenter<Environment, EnvironmentService, EnvironmentGridPresenter, EnvironmentGridView> {
    ...
    @Autowired
    public EnvironmentGridPresenter(EnvironmentDataProvider environmentDataProvider, NavigationManager navigationManager, EnvironmentService service, BeanFactory beanFactory,
                                    ViewEventBus viewEventBus, PropertyService propertyService, TedamUserService userService) {
        super(navigationManager, service, environmentDataProvider, beanFactory, viewEventBus, propertyService, userService);
    }

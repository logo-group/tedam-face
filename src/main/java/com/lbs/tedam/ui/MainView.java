...
import com.lbs.tedam.app.security.UserSessionAttr;
...
public class MainView extends HorizontalLayout implements ViewDisplay, TedamLocalizerWrapper {
	...
	public MainView(NavigationManager navigationManager, SecuredViewAccessControl viewAccessControl,
			TedamUserService userService) throws LocalizedException {
	...
	private Component buildMenu() throws LocalizedException {
		...
		language = new TedamButton("view.mainview.otherLanguage", VaadinIcons.GLOBE);
	 ...
	 * @param targetView       the view to navigate to when the user clicks the
	 *                         button
	 */

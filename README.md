...
When a job is created; it need following components: Test Sets which will be executed, [agents](https://github.com/logobs/tedam-agent) which run jobs, [environment](https://github.com/logobs/tedam/wiki/How-to-define-Environment?) which job runs on it
